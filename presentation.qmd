...
## methods - overview {.flexbox .vcenter}
...
::: {.fragment}   
<center> How do you *want* to be wrong? </center>
:::
...
::: {.fragment}   
<center> the downsides of predicting non-suitable habitat where it really is? </center>    
:::
...
::: {.fragment}   
<center> other projects? priorities? deadlines? </center>
:::
...
::: {.fragment}
mutualisms?  
<center> *modelling two species together, joint-SDMs* </center>
:::
...
::: {.fragment}
competition?  
<center> *using suitability surfaces to plant assemblages of species in field experiments'* </center>
:::
...
::: {.fragment}
dispersal?  
<center> *using gridded surfaces to model the probability of dispersal from known to suitable habitat*  </center>
:::
