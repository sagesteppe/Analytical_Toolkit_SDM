...
Hi my name is Reed, I am a PBC masters student who is really hopefully graduating next week. I have been invited to do a guest lecture on the topic of *species distribution models*, if you have not heard of these, what they are is a hypothesis, projected onto a map, of where we might expect to find a species. Also, this tech is totally lo-fi because I am trying to graduate next week, so...!
...
<div class="notes">
Our general talk is going to fall the revolutionary formula you see here. We are basically just going to go over the really broad aspects of a model, so that if you are interested in generating one, you have something of road map for the process. Is anyone already planning on generating any of these? 
...
They are now able to accomodate some information on obligate mutualisms.
</div>
...
## evaluation IV - example {.flexbox .vcenter}
